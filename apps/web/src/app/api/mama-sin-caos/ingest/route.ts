...
import { upsertMamaSinCaosLead } from '@/lib/mama-sin-caos/leads-store';
...
export async function POST(request: Request) {
  try {
    ...
    const backendUrl = `${getMamaSinCaosBackendBaseUrl()}${MAMA_SIN_CAOS_LEADS_API_PATH}`;
    ...
    return NextResponse.json(
      {
        ok: false,
        error: 'Failed to save mama sin caos lead',
