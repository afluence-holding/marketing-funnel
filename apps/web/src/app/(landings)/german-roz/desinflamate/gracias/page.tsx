...
export const metadata: Metadata = {
  title: '¡Gracias! — Reto Desinflámate · Germán Roz',
  description:
    'Tu compra del Reto Desinflámate está confirmada. Pronto recibirás toda la información por WhatsApp.',
  robots: { index: false, follow: false },
};

export default function DesinflamateGraciasPage() {
  return (
    <>
      ...
      <main className="ty-main">
        ...
        <section className="ty-hero">
          ...
          <h1 className={`ty-title ${serif.className}`}>¡Tu cupo está confirmado!</h1>
          ...
          <div className={`ty-badge ${display.className}`}>Compra confirmada</div>
        </section>

        <section className="ty-body">
          <p>
            Queremos darte las <strong>gracias de corazón</strong> por confiar en este proceso. Tu
            compra del <strong>Reto Desinflámate</strong> está confirmada.
          </p>

          <p>
            En los <strong>próximos minutos</strong> vas a recibir un correo y un mensaje de{' '}
            <strong>nuestro WhatsApp oficial</strong> al número que registraste en la compra, con{' '}
            <strong>toda</strong> la información del reto. No necesitas hacer nada más — el equipo se
...
const styles = `
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .ty-bg {
    ...
    z-index: 0;
    background:
      radial-gradient(ellipse 80% 50% at 50% 0%, rgba(255, 87, 34, 0.32) 0%, transparent 70%),
      #0a0a0a;
    pointer-events: none;
  }
  ...
  .ty-check {
    width: 3.5rem;
    height: 3.5rem;
    border: 1.5px solid rgba(255, 87, 34, 0.55);
    border-radius: 50%;
    display: flex;
    align-items: center;
  ...
  .ty-body strong { color: #fff; font-weight: 600; }
  ...
  .ty-list li strong { color: #fff; }

  .ty-icon { flex-shrink: 0; font-size: 1.1rem; line-height: 1.6; }
  ...
  .ty-footer a:hover { color: rgba(255, 255, 255, 0.6); }

  @media (max-width: 480px) {
    .ty-hero { padding: 2.5rem 1.25rem 2rem; }
    .ty-body { padding: 2rem 1.5rem; margin: 0 0.75rem; border-radius: 10px; }
  }
`;
